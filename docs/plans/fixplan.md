...
- Critically - MUST BE FIXED: 
  ...
  - The machine set currently DOES NOT SET the correct networks, template, workspace - datacenter,datastore,folder, resourcePool or server - these values should be coming from the VmwareCloudFoundationMigration.
